...
<h2  class="text-center" style="background-color:powderblue;" >YashEssence</h2><br><br>

	<div class="text-center">
	<button  class="btn btn-primary">
	<a href="insertItemPage"> Add an item</a>
	</button></div>
	<br><br>
	<div class="text-center">
		<button  class="btn btn-primary">
		<a href="insertMultiItemsPage">Add multiple items</a>
		</button></div>
		<br><br>
